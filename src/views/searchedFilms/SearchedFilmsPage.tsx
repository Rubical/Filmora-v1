...
import { useSearchedFilms } from "@/shared/hooks/useSearchedFilms"
...
const SearchedFilmsPage: FC = () => {
	...
	const { filmsFound, loading, totalPages, page, filmQuery } = useSearchedFilms()
	const { changeSearchedFilmPage, fetchSearchedFilms, setFavouriteFilm } = useActions()
