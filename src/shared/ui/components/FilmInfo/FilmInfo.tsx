...
import { IFilm, TypeFilmGenre } from "../../types/film-details.types"
		...
		>
			...
			>
				<img
					...
					src={
						poster_path ? `https://www.themoviedb.org/t/p/original/${poster_path}` : imgPlaceholder
					}
					alt="poster"
				/>
			</Box>
			...
			{vote_average ? (
				...
				>
					...
					>
						...
						<Typography sx={{ fontSize: { xs: "13px", md: "16px" } }}>Rating</Typography>
					</Box>
				</Box>
			) : (
				""
			...
			{overview ? (
				<Box>
					...
					<Typography sx={{ maxWidth: "100%", fontSize: { xs: "14px", md: "16px" } }}>
						{overview}
					</Typography>
				</Box>
			) : (
